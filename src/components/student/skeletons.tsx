...
const ShimmerSkeleton = ({ className, ...props }: React.ComponentProps<typeof Skeleton>) => (
  <Skeleton variant="shimmer" className={className} {...props} />
);
...
// Student List Page Skeleton
export function StudentListPageSkeleton({ showStats = true }: { showStats?: boolean }) {
  return (
    <div className="space-y-6">
      {/* Header Skeleton */}
      <div>
        ...
        <CardContent className="p-0">
          <div className="p-4 space-y-4">
            ...
            {[...Array(5)].map((_, rowIndex) => (
              <div key={rowIndex} className="grid grid-cols-5 gap-4 items-center px-4 py-3 border-t">
