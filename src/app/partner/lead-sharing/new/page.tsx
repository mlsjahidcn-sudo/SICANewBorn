  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#1B2A4A]">New Lead</h1>
          <p className="text-[#4B5563] mt-1 text-sm">Capture an inquiry from a prospective student</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card className="rounded-none">
          <CardContent className="p-6 space-y-6">
            <div>
              <h2 className="text-lg font-semibold text-[#1B2A4A] mb-4">Lead Information</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <Label htmlFor="leadEmail" className="text-[#1B2A4A] mb-2 block">Email</Label>
                  <Input id="leadEmail" name="leadEmail" type="email" value={formData.leadEmail} onChange={handleInputChange} className="rounded-none" placeholder="lead@example.com" />
                </div>
                <div>
                  <Label htmlFor="leadPhone" className="text-[#1B2A4A] mb-2 block">Phone</Label>
                  <Input id="leadPhone" name="leadPhone" type="tel" value={formData.leadPhone} onChange={handleInputChange} className="rounded-none" placeholder="+1 555 0100" />
                </div>
                <div>
                  <Label htmlFor="interestedProgram" className="text-[#1B2A4A] mb-2 block">Interested Program</Label>
                  <Input id="interestedProgram" name="interestedProgram" value={formData.interestedProgram} onChange={handleInputChange} className="rounded-none" placeholder="e.g., MBA, Computer Science" />
                </div>
                <div>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Where did this lead come from? What are they looking for?"
              />
            </div>
          </CardContent>
        </Card>
