...
/**
 * Phase 92: this was the whole /scholarships/[slug] page as one client
 * component that imported the full static scholarship catalog from
 * data.ts (~half of the 101KB module) just to `.find()` one slug.
 * It's now a client island rendered by the server page, which fetches
 * the single scholarship and passes it as a prop — the seed catalog
 * no longer ships in the client bundle.
 */
...
export default function ScholarshipDetailClient({ scholarship }: { scholarship: Scholarship }) {
