...
export default function LeadDetailPage() {
  ...
  // WABPO WhatsApp send — phase 45a — REMOVED in Phase 98 (WABPO
  // integration dropped; see AGENTS.md Phase 98 item 5).
  ...
  return (
    <div className="space-y-6">
      ...
      {/* WABPO WhatsApp send modal — phase 45a — REMOVED in Phase 98 */}
    </div>
  );
}
